...
const Button = ({ label, history, clearGizmoOnOperation }) => {
  ...
  return (
    <button
      className="bg-blue-500 w-20 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded select-none disabled:opacity-50 disabled:hover:bg-blue-500 disabled:cursor-not-allowed"
