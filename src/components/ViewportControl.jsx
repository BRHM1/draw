  ...
  return (
    <div className="flex-col justify-center items-center gap-2 mb-2 ml-2 z-50 absolute bottom-0 left-2">
      ...
      <div className="flex items-center mt-1 justify-center">
        ...
        <button className="w-20 h-8 flex items-center justify-center bg-blue-500 hover:bg-blue-700 text-white  py-2 px-4 select-none disabled:opacity-50 disabled:hover:bg-blue-500 disabled:cursor-not-allowed">
          {`${zoom * 100} %`}
        </button>
